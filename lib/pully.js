...
var Pully = function (videoType, audioType) {
    this.videoEncoding = videoType || 'mp4';
    this.audioEncoding = audioType || 'mp4';
}

Pully.prototype.download = function (url, callback) {
    (function (me) {
...
Pully.prototype.downloadVideo = function (url, callback) {
    var me = this;
    ytdl.getInfo(url, {
        downloadUrl: true
    }, function (err, info) {
...
Pully.prototype.downloadAudio = function (url, callback) {
    var me = this;
