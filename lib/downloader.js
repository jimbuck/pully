...
var ytdl, ffmpeg, PresetManager;

var Downloader = function(youtubeDownloader, fluentffmpeg, presetManager){
  ytdl = youtubeDownloader || require('ytdl-core');
  ffmpeg = fluentffmpeg || require('fluent-ffmpeg');
  PresetManager = presetManager || require('../lib/preset-manager');
}
...
Downloader.prototype.download = function (options, callback) {
  ...
  ytdl.getInfo(options.url, {
      ...
      beginDownload.call(this, preset, info, options, callback);
    }.bind(this));
};
...
function beginDownload (preset, info, options, callback){
...
function downloadToStream(format, info, options, callback) {
...
function downloadAndMerge(formats, info, options, callback) {
  ...
  downloadToTemp(formats.audio, info, options, function (err, audioPath, done) {
