...
function downloadRunner(url, format, extension, info, callback) {
    ...
    function printVideoInfo(info, format) {
        ...
        console.log('----');
        //console.log('resolution: '.yellow.bold + format.resolution);
        //console.log('encoding: '.grey.bold + format.encoding);
        //console.log('size: '.cyan.bold + util.toHumanSize(format.size) + ' (' + format.size + ' bytes)');
